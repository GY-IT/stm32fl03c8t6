...
for k = 1:1:num_h       %   10个速度
    ...
    if  k == 1
        ...
        fun_f{:, k} =  2*xP(:,k)'*N{:,k}*[fun_r_P_k{2*k-1:2*num_h_add_1,:}]' + [fun_r_P_k{2*k-1:2*num_h_add_1,:}]*M{:,k}*[fun_r_P_k{2*k-1:2*num_h_add_1,:}]'; 
    else
